...
(* OASIS_START *)
(* DO NOT EDIT (digest: 972c501721695fb5dc4b961450382095) *)
(*
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["curl-helper.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["-fPIC"])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lcurl"])];
